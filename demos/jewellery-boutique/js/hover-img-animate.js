...
// script
{
  ...
  class HoverImgFx {
    ...
    initEvents() {
      this.positionElement = (ev) => {
        ...
        this.DOM.reveal.style.top = `${mousePos.y - docScrolls.top - this.DOM.reveal.offsetHeight / 2}px`;
        this.DOM.reveal.style.left = `${mousePos.x - docScrolls.left - this.DOM.reveal.offsetWidth / 2}px`;
      };
  ...
  [...document.querySelectorAll(".img-hover-block")].forEach(
