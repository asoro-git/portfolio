                ...
                X
                  ...
                  : Y
                    ...
                    : s
                      ...
                      : ((j.y =
                          parseFloat(e.style.top || ((i = ia(e)) && i.top)) ||
                          0),
                        (j.x =
                          parseFloat(e.style.left || (i || {}).left) || 0)),
                (C || F || E) &&
                  !n &&
                    ...
                    Y
                      ...
                      : Cs(n.bounds.maxX) && Cs(n.bounds.maxY)
                        ? ((r = ua(e, e.parentNode)),
                          ...
                          (j.minY = m =
                            Math.round(it(z, "px") + t.top - r.top)),
          ...
          if (((l = i.charAt(s)), _ && (c = _(i.substr(s), e.specialChars))))
            ...
            "{" === l && "{{LT}}" === i.substr(s, 6)
              ...
              : (l.charCodeAt(0) >= 55296 && l.charCodeAt(0) <= 56319) ||
                ...
                ? ((a =
                    ((i.substr(s, 12).split(hu) || [])[1] || "").length || 2),
                  (o +=
                    p && " " !== l
                      ? r() + i.substr(s, a) + "</" + f + ">"
                      : i.substr(s, a)),
