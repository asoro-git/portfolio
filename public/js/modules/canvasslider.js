          ...
          selector.forEach(function (element) {
            ...
            var elDirection =
              ...
              elAutoPlayDisableOnInteraction =
                element.getAttribute("data-autoplay-disable-on-interaction") ||
                true,
                ...
                on: {
                  afterInit: function (swiper) {
                    ...
                    if (element.querySelectorAll(".yt-bg-player").length > 0) {
                      ...
                      var activeYTVideo = jQuery(".swiper-slide-active").find(
                    ...
                    document
                      .querySelectorAll(".swiper-slide-active [data-animate]")
                      .forEach(function (el) {
