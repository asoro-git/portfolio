      ...
      if (
        ...
        if (
          ...
          if (_settings.scrollPos.y > _settings.sliderPx.offset) {
            if (
              typeof _settings.sliderPx.el.querySelector(".slider-inner") ===
              "object"
            ) {
              _transform =
  ...
  var _offset = function () {
    ...
    if (
      ...
      (__core.getVars.elHeader &&
        __core.getNext(__core.getVars.elHeader, ".include-header").length > 0)
    ) {
      headerHeight = 0;
    }
  ...
  var _elementFade = function (_settings) {
    ...
    fastdom.mutate(function () {
      if (
        ...
        if (
          _settings.sliderPx.el.classList.contains("slider-parallax-visible")
        ) {
