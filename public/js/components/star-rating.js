    ...
    (a.prototype = {
      ...
      _parseValue: function (t) {
        var e = this,
          a = parseFloat(t);
        return (
          isNaN(a) && (a = e.clearValue),
          !e.zeroAsNull || (0 !== a && "0" !== a) ? a : null
        );
      },
      ...
      _initSlider: function (t) {
        var a = this,
          n = a.$element.val();
        ((a.initialValue = e.isEmpty(n) ? 0 : n),
          a._setDefault("min", a._parseAttr("min", t)),
          a._setDefault("max", a._parseAttr("max", t)),
          a._setDefault("step", a._parseAttr("step", t)),
          (isNaN(a.min) || e.isEmpty(a.min)) && (a.min = e.DEFAULT_MIN),
          (isNaN(a.max) || e.isEmpty(a.max)) && (a.max = e.DEFAULT_MAX),
          (isNaN(a.step) || e.isEmpty(a.step) || 0 === a.step) &&
            (a.step = e.DEFAULT_STEP),
          (a.diff = a.max - a.min),
          a._setDefault("minThreshold", a.min),
          a.minThreshold < a.min && (a.minThreshold = a.min),
          a.minThreshold > a.max && (a.minThreshold = a.max));
      },
      _initHighlight: function (t) {
        ...
        (t || (t = a.$element.val()),
          ...
          (a.cache = { caption: n, width: e, val: t }));
      },
      _getContainerCss: function () {
        var t = this;
        return (
          "rating-container" +
          e.getCss(t.theme, "theme-" + t.theme) +
          e.getCss(t.rtl, "rating-rtl") +
          e.getCss(t.size, "rating-" + t.size) +
          e.getCss(t.animate, "rating-animate") +
          e.getCss(t.disabled || t.readonly, "rating-disabled") +
          e.getCss(t.containerClass, t.containerClass) +
          (t.displayOnly ? " is-display-only" : "")
        );
      },
      ...
      _generateRating: function () {
        var a,
          ...
          r = this,
          s = r.$element;
        ((n = r.$container = t(document.createElement("div")).insertBefore(s)),
          e.addCss(n, r._getContainerCss()),
          (r.$rating = a =
          ...
          r.keyboardEnabled && r.$rating.attr("tabindex", r.tabindex),
      ...
      _getCaption: function () {
        var t = this;
        return t.$caption && t.$caption.length
          ? t.$caption.html()
          : t.defaultCaption;
      },
      ...
      _getClearClass: function () {
        var t = this;
        return (
          t.clearButtonBaseClass +
          " " +
          (t.inactive ? "" : t.clearButtonActiveClass)
        );
      },
      _toggleHover: function (t) {
        ...
        t &&
          (i.hoverChangeStars &&
            ...
            (a = t.val <= i.clearValue ? e + "%" : t.width),
            i.$filledStars.css("width", a)),
          i.hoverChangeCaption &&
            ((n =
              t.val <= i.clearValue ? i.fetchCaption(i.clearValue) : t.caption),
            n && i._setCaption(n + "")));
      },
      _init: function (a) {
        var n,
      ...
      _initCaptionTitle: function () {
        var e,
          a = this;
        ((e = a.fetchCaption(a.$element.val())),
          a.$rating.attr("title", t(e).text()));
      },
      _trigChange: function (t) {
        var e = this;
        (e._initStarTitles(),
          e.$element.trigger("change").trigger("rating:change", t));
      },
        ...
        t.events = {
          ...
          initTouch: function (a) {
            ...
            h &&
              ...
              (r = t.events._getTouchPosition(i[0])),
              "touchend" === a.type
                ? (t._setStars(r),
                  (u = [t.$element.val(), t._getCaption()]),
                  t._trigChange(u),
                  (t.starClicked = !0))
                : ((s = t.calculate(r)),
                  (o = s.val <= d ? t.fetchCaption(d) : s.caption),
                  (l = t.getWidthFromValue(d)),
                  (c = s.val <= d ? l + "%" : s.width),
                  t._setCaption(o),
          ...
          starMouseMove: function (e) {
            ...
            t.events._noMouseAction(e) ||
              ...
              (n = t.calculate(a)),
              t._toggleHover(n),
              t.$element.trigger("rating:hover", [n.val, n.caption, "stars"]));
          },
          ...
          clearMouseMove: function (e) {
            ...
            !t.events._noMouseAction(e) &&
              ...
              (a =
                ...
                "</span>"),
              (n = t.clearValue),
              (i = t.getWidthFromValue(n) || 0),
              (r = { caption: a, width: i, val: n }),
              t._toggleHover(r),
              t.$element.trigger("rating:hover", [n, a, "clear"]));
          },
          ...
          keydown: function (a) {
            if (!t.inactive && t.keyboardEnabled) {
              ...
              (d === l && u < t.max && ((u += s), (r = !0)),
                d === c && u > t.minThreshold && ((u -= s), (r = !0)),
                r &&
                  ((u = e.applyPrecision(u, o)),
                  n.val(u),
                  t._trigChange([u, t._getCaption()]),
                  t.showStars(n.val()),
                  t.$rating.focus()),
                (37 !== d && 39 !== d) ||
                  n.trigger("rating:keydown", [u, t._getCaption()]));
            }
          },
        };
      },
      ...
      _initStarTitles: function (e) {
        ...
        ((n = function (a) {
          ...
          n(a.$emptyStars.find(".star")),
          n(a.$filledStars.find(".star")));
      },
      ...
      getValueFromPosition: function (t) {
        ...
        return (
          ...
          (a = e.applyPrecision(parseFloat(i.min + n * i.step), r)),
          (a = Math.max(Math.min(a, i.max), i.minThreshold)),
          i.rtl ? i.max - a : a
        );
      },
      getWidthFromValue: function (t) {
        var e,
          ...
          r = n.max,
          s = n.$emptyStars;
        return !t || t <= n.min || i === r
          ? 0
          : ((t = Math.max(t, n.minThreshold)),
            (a = s.outerWidth()),
            (e = a ? s.width() / a : 1),
      ...
      fetchCaption: function (t) {
        ...
        return (
          l &&
            l !== o.clearValue &&
            (l = e.applyPrecision(l, e.getDecimalPlaces(o.step))),
          (r = "function" == typeof u ? u(l, d) : u[l]),
          (i = "function" == typeof c ? c(l, d) : c[l]),
          (n = e.isEmpty(i) ? o.defaultCaption.replace(/\{rating}/g, l) : i),
          (a = e.isEmpty(r) ? o.clearCaptionClass : r),
          (s = l === o.clearValue ? o.clearCaption : n),
          '<span class="' + a + '">' + s + "</span>"
        );
      },
      destroy: function () {
        var a = this,
          n = a.$element;
        return (
          e.isEmpty(a.$container) || a.$container.before(n).remove(),
      ...
      clear: function () {
        var t = this,
          e =
            ...
            "</span>";
        return (
          t.inactive || t._setCaption(e),
          t.showStars(t.clearValue).trigger("change").trigger("rating:clear")
        );
      },
      reset: function () {
        var t = this;
