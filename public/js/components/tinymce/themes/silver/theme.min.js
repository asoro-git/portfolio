      ...
      collection: G_((e, t, o) =>
        ((e, t, o) => {
          const n = e.label.map((e) => pS(e, t)),
            ...
            r = s((o, n, s, r) => {
              (n.stop(),
                t.isDisabled() || Ir(o, vS, { name: e.name, value: r }));
            }),
            a = [
              Ur(
                qs(),
                  ...
                  onSetValue: (o, n) => {
                    (((o, n) => {
                      const s = H(n, (o) => {
                          ...
                          return `<div class="tox-collection__item${t.isDisabled() ? " tox-collection__item--state-disabled" : ""}" tabindex="-1" data-collection-item-value="${dS.encodeAllRaw(o.value)}" title="${i}" aria-label="${i}">${r}${s}</div>`;
                        }),
                        r =
      ...
      var Ee = function (e) {
        ...
        Ie = function (e) {
          ...
          if (
            ...
            return (Ee(e), !0);
          if ("select" === s && yN(/<template/i, e.innerHTML))
            return (Ee(e), !0);
          if (!L[s] || G[s]) {
            if (!G[s] && Ne(s)) {
