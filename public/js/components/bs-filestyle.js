 ...
 */ var KrajeeFileTypeConfig = {
  ...
  tarHeaderChecksumMatches: function (e, i = 0) {
  ...
  uint32SyncSafeToken: {
    get: function (e, i) {
      return (
        (127 & e[i + 3]) | (e[i + 2] << 7) | (e[i + 1] << 14) | (e[i] << 21)
      );
    },
    len: 4,
  },
...
class BufferTokenizer {
  ...
  async readToken(e, i = this.position) {
    let t = Buffer.alloc(e.len),
      $ = await this.readBuffer(t, { position: i });
    if ($ < e.len) throw new EndOfStreamError();
    return e.get(t, 0);
  }
  async peekToken(e, i = this.position) {
    let t = Buffer.alloc(e.len),
      $ = await this.peekBuffer(t, { position: i });
    if ($ < e.len) throw new EndOfStreamError();
    return e.get(t, 0);
  }
  ...
  async peekBuffer(e, i) {
    let t = this.normalizeOptions(e, i),
      $ = Math.min(this.uint8Array.length - t.position, t.length);
    if (t.mayBeLess || !($ < t.length))
      return (
        e.set(this.uint8Array.subarray(t.position, t.position + $), t.offset),
        $
      );
  ...
  normalizeOptions(e, i) {
    if (i && void 0 !== i.position && i.position < this.position)
      throw Error(
        "`options.position` must be equal or greater than `tokenizer.position`",
      );
    return i
...
class FileTypeParser {
  _check(e, i, t) {
    for (let [$, r] of ((t = { offset: 0, ...t }), i.entries()))
      if (t.mask) {
  ...
  async parseTokenizer(e) {
    ...
    if (this.check([37, 33]))
      return (await e.peekBuffer(this.buffer, { length: 24, mayBeLess: !0 }),
    ...
    if (this.checkString("ID3")) {
      ...
      return e.position + t > e.fileInfo.size
        ...
        : (await e.ignore(t),
          console.log("KV SAYS", typeof e, e),
          fileTypeFromTokenizer(e));
    }
    ...
    if (this.check([80, 75, 3, 4])) {
      try {
        for (; e.position + 30 < e.fileInfo.size; ) {
          ...
          if (
            (($.filename = await e.readToken(
              new StringType($.filenameLength, "utf-8"),
            )),
            await e.ignore($.extraFieldLength),
            "META-INF/mozilla.rsa" === $.filename)
          )
          ...
          if (
            ...
            let x = (
              await e.readToken(new StringType($.compressedSize, "utf-8"))
            ).trim();
            switch (x) {
          ...
          if (0 === $.compressedSize) {
            ...
            for (; n < 0 && e.position < e.fileInfo.size; )
              (await e.peekBuffer(this.buffer, { mayBeLess: !0 }),
                (n = this.buffer.indexOf("504B0304", 0, "hex")),
                await e.ignore(n >= 0 ? n : this.buffer.length));
    ...
    if (this.checkString("OggS")) {
      ...
      this._check(a, [79, 112, 117, 115, 72, 101, 97, 100]))
          ...
          : this._check(a, [1, 118, 105, 100, 101, 111, 0])
            ...
            : this._check(a, [127, 70, 76, 65, 67])
              ...
              : this._check(a, [83, 112, 101, 101, 120, 32, 32])
                ...
                : this._check(a, [1, 118, 111, 114, 98, 105, 115])
    ...
    if (this.checkString("%PDF")) {
      ...
      return (await e.readBuffer(c, { mayBeLess: !0 }),
    ...
    if (this.check([26, 69, 223, 163])) {
      async function h() {
        let t = await e.peekNumber(i.UINT8),
          $ = 128,
          r = 0;
        for (; (t & $) == 0; ) (++r, ($ >>= 1));
    ...
    if (this.check([137, 80, 78, 71, 13, 10, 26, 10])) {
      async function d() {
        return {
          length: await e.readToken(i.INT32_BE),
          type: await e.readToken(new StringType(4, "binary")),
        };
      }
      await e.ignore(8);
      do {
    ...
    if (this.check([48, 38, 178, 117, 142, 102, 207, 17, 166, 217])) {
      async function F() {
        ...
        return (
          ...
          { id: t, size: Number(await e.readToken(i.UINT64_LE)) }
        );
      }
    ...
    if (
      this.check([254, 255, 0, 60, 0, 63, 0, 120, 0, 109, 0, 108]) ||
      this.check([255, 254, 60, 0, 63, 0, 120, 0, 109, 0, 108, 0])
    )
      return { ext: "xml", mime: "application/xml" };
    ...
    if (this.check([4, 0, 0, 0]) && this.buffer.length >= 16) {
      ...
      if (y > 12 && this.buffer.length >= y + 16)
        try {
          let v = this.buffer.slice(16, y + 16).toString(),
            E = JSON.parse(v);
    ...
    if (
      ...
      KrajeeFileTypeConfig.tarHeaderChecksumMatches(this.buffer))
    )
      return { ext: "tar", mime: "application/x-tar" };
    if (
      this.check([
        255, 254, 255, 14, 83, 0, 107, 0, 101, 0, 116, 0, 99, 0, 104, 0, 85, 0,
        112, 0, 32, 0, 77, 0, 111, 0, 100, 0, 101, 0, 108, 0,
      ])
    )
  ...
  async readTiffTag(e) {
    let i = KrajeeFileTypeConfig.Token,
      t = await this.tokenizer.readToken(e ? i.UINT16_BE : i.UINT16_LE);
  ...
  async readTiffHeader(e) {
    let i = KrajeeFileTypeConfig.Token,
      t = (e ? i.UINT16_BE : i.UINT16_LE).get(this.buffer, 2),
...
!(function () {
  ...
  function r(e, t, r) {
    ...
    if ("Byte" == t)
      ...
      ((o = e.length), 1 >= o ? (f = i(e)) : ((f = s(">L", [r])), (S = i(e))));
    else if ("Ascii" == t)
      ((l = e + "\x00"),
        (o = l.length),
        o > 4 ? ((f = s(">L", [r])), (S = l)) : (f = l + p("\x00", 4 - o)));
    else if ("Rational" == t) {
  ...
  function s(e, t) {
    ...
    for (var n = "", i = 1, r = null, o = null, l = null; (o = e[i]); ) {
      if ("b" == o.toLowerCase()) {
        if (((r = t[i - 1]), "b" == o && 0 > r && (r += 256), r > 255 || 0 > r))
          throw new Error("'pack' error.");
        l = String.fromCharCode(r);
      } else if ("H" == o) {
        if (((r = t[i - 1]), r > 65535 || 0 > r))
          throw new Error("'pack' error.");
        ((l =
  ...
  function m(e, t) {
    ...
    for (var a = 0, n = 1; n < e.length; n++)
      if ("b" == e[n].toLowerCase()) a += 1;
      else if ("h" == e[n].toLowerCase()) a += 2;
      else {
        if ("l" != e[n].toLowerCase())
  ...
  function y(e) {
    ...
    for (var t = 2, a = ["د"]; ; ) {
      ...
      var n = m(">H", e.slice(t + 2, t + 4))[0],
        i = t + n + 2;
      if ((a.push(e.slice(t, i)), (t = i), t >= e.length))
  ...
  function f(e, t) {
    ...
    return (
      e.forEach(function (i, r) {
        "؇" == i.slice(0, 2) &&
          "Exif\x00\x00" == i.slice(4, 10) &&
          (a ? n.unshift(r) : ((e[r] = t), (a = !0)));
      }),
      n.forEach(function (t) {
        e.splice(t, 1);
      }),
      !a && t && (e = [e[0], t].concat(e.slice(1))),
      e.join("")
    );
  }
  var c = {};
  if (
    ...
    (c.load = function (e) {
      ...
      if (
        ...
        34665 in a["0th"] &&
          ((i = a["0th"][34665]), (a.Exif = n.get_ifd(i, "Exif"))),
        34853 in a["0th"] &&
          ((i = a["0th"][34853]), (a.GPS = n.get_ifd(i, "GPS"))),
        40965 in a.Exif &&
          ((i = a.Exif[40965]), (a.Interop = n.get_ifd(i, "Interop"))),
        "\x00\x00\x00\x00" != r &&
          ((i = m(n.endian_mark + "L", r)[0]),
          (a["1st"] = n.get_ifd(i, "1st")),
          513 in a["1st"] && 514 in a["1st"]))
      ) {
        var o = a["1st"][513] + a["1st"][514],
          s = n.tiftag.slice(a["1st"][513], o);
        a.thumbnail = s;
      }
      return a;
    }),
    (c.dump = function (a) {
      var n,
        ...
        p = 8,
        y = e(a),
        S = "Exif\x00\x00MM\x00*\x00\x00\x00\b",
        f = !1,
        h = !1,
        d = !1,
        u = !1;
      ((n = "0th" in y ? y["0th"] : {}),
        ...
        ("Interop" in y && Object.keys(y.Interop).length)
          ? ((n[34665] = 1),
            ...
            (i = y.Exif),
            "Interop" in y && Object.keys(y.Interop).length
              ? ((i[40965] = 1), (d = !0), (r = y.Interop))
              : Object.keys(i).indexOf(
                  c.ExifIFD.InteroperabilityTag.toString(),
                ) > -1 && delete i[40965])
          : Object.keys(n).indexOf(c.ImageIFD.ExifTag.toString()) > -1 &&
            delete n[34665],
        "GPS" in y && Object.keys(y.GPS).length
          ? ((n[c.ImageIFD.GPSTag] = 1), (h = !0), (l = y.GPS))
          : Object.keys(n).indexOf(c.ImageIFD.GPSTag.toString()) > -1 &&
            delete n[c.ImageIFD.GPSTag],
        "1st" in y &&
          "thumbnail" in y &&
          null != y.thumbnail &&
      ...
      var P,
        ...
        x,
        I = o(n, "0th", 0),
        D = I[0].length + 12 * f + 12 * h + 4 + I[1].length,
        G = "",
        A = 0,
        v = "",
        b = 0,
        ...
        T = "";
      if (
        (f && ((P = o(i, "Exif", D)), (A = P[0].length + 12 * d + P[1].length)),
      ...
      if (u) {
        var k = D + A + b + E;
        if (((L = o(m, "1st", k)), (x = t(y.thumbnail)), x.length > 64e3))
    ...
    (l.prototype = {
      get_ifd: function (e, t) {
        var a,
          n = {},
          i = m(this.endian_mark + "H", this.tiftag.slice(e, e + 2))[0],
          r = e + 2;
        ...
        return (
          "0th" == t &&
            ((e = r + 12 * i),
            (n.first_ifd_pointer = this.tiftag.slice(e, e + 4))),
          n
        );
      },
        ...
        if (1 == n)
          i > 4
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = m(
                this.endian_mark + p("B", i),
                this.tiftag.slice(t, t + i),
              )))
            : (a = m(this.endian_mark + p("B", i), r.slice(0, i)));
        else if (2 == n)
          i > 4
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = this.tiftag.slice(t, t + i - 1)))
            : (a = r.slice(0, i - 1));
        else if (3 == n)
          i > 2
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = m(
                this.endian_mark + p("H", i),
                this.tiftag.slice(t, t + 2 * i),
              )))
            : (a = m(this.endian_mark + p("H", i), r.slice(0, 2 * i)));
        else if (4 == n)
          i > 1
            ? ((t = m(this.endian_mark + "L", r)[0]),
              (a = m(
                this.endian_mark + p("L", i),
                this.tiftag.slice(t, t + 4 * i),
              )))
            : (a = m(this.endian_mark + p("L", i), r));
        else if (5 == n)
    ...
    var h = function (e) {
      for (
        ...
        ((t = e.charCodeAt(m++)),
          ...
          (o = ((15 & a) << 2) | (n >> 6)),
          (l = 63 & n),
          isNaN(a) ? (o = l = 64) : isNaN(n) && (l = 64),
          (s = s + p.charAt(i) + p.charAt(r) + p.charAt(o) + p.charAt(l)));
      return s;
    };
  ...
  ((u["0th"] = u.Image),
    ...
    (c.InteropIFD = { InteroperabilityIndex: 1 }),
    (c.GPSHelper = {
  ...
  ((t = {
    ...
    closeButton: function (e) {
      return (
        ...
        '<button type="button" class="btn btn-light bg-transparent btn-sm ' +
          e +
          '" aria-label="Close">\n' +
