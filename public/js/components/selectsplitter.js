  ...
  ((r.DEFAULTS = {
    ...
    (r.prototype.updateParentCategory = function () {
      ...
      for (var r in e.fullCategoryList[e.currentParentCategory])
        e.fullCategoryList[e.currentParentCategory].hasOwnProperty(r) &&
          (t =
            t +
            '<option value="' +
            e.fullCategoryList[e.currentParentCategory][r].x +
            '">' +
            e.fullCategoryList[e.currentParentCategory][r].y +
            "</option>");
      (e.$secondSelect.append(t),
        e.$selectedOption &&
          e.$secondSelect
            .find('option[value="' + e.$selectedOption.attr("value") + '"]')
            .attr("selected", "selected"));
    }),
    (r.prototype.updateChildCategory = function (t) {
      ...
      ((r.currentChildCategory = e(t.target).val()),
        ...
        r.$element
          .find('option[value="' + r.currentChildCategory + '"]')
          .attr("selected", "selected"),
    ...
    (r.prototype.destroy = function () {
      var e = this;
      (e.$wrapper.remove(), e.$element.removeData(e.type), e.$element.show());
    }),
