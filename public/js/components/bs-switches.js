        ...
        function t(t, i) {
          (null == i && (i = {}),
              ...
              class: (function (t) {
                return function () {
                  ...
                  return (
                    ...
                    t.options.inverse &&
                      e.push(t.options.baseClass + "-inverse"),
                    t.$element.attr("id") &&
                      e.push(
            ...
            this.$element.on(
              ...
              (function (i) {
                return function (n) {
                  return !1 === i.options.onSwitchChange.apply(t, arguments)
                    ? i.$element.is(":radio")
          ...
          (t.prototype._width = function () {
            ...
            return (
              ...
              this.$label.width(
                (function (t) {
                  return function (i, n) {
                    return "auto" !== t.options.labelWidth
              ...
              "previousState.bootstrapSwitch": (function (t) {
                return function (e) {
                  return (
                    ...
                    t.options.indeterminate &&
                      t.$wrapper.addClass(
                        t.options.baseClass + "-indeterminate",
                      ),
                    t.$element
