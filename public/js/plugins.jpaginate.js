...
(function ($) {
  $.fn.pajinate = function (options) {
    ...
    return this.each(function () {
      ...
      var more =
        '<li class="page-item disabled ellipse more"><a class="page-link" href="#">...</a></li>';
      var less =
        '<li class="page-item disabled ellipse less"><a class="page-link" href="#">...</a></li>';
