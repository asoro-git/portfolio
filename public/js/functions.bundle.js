  ...
  var Modules = (function () {
    return {
      ...
      lazyLoad: function (element) {
        CNVS.LazyLoad &&
          CNVS.LazyLoad.init(element ? element : ".lazy:not(.lazy-loaded)");
      },
      ...
      lightbox: function (element) {
        CNVS.Lightbox &&
          CNVS.Lightbox.init(element ? element : "[data-lightbox]");
      },
      ...
      animations: function (element) {
        CNVS.Animations &&
          CNVS.Animations.init(element ? element : "[data-animate]");
      },

      hoverAnimations: function (element) {
        CNVS.HoverAnimations &&
          CNVS.HoverAnimations.init(element ? element : "[data-hover-animate]");
      },
      ...
      filterInit: function (element) {
        CNVS.Filter &&
          CNVS.Filter.init(element ? element : ".grid-filter,.custom-filter");
      },

      canvasSlider: function (element) {
        CNVS.CanvasSlider &&
          CNVS.CanvasSlider.init(element ? element : ".swiper_wrapper");
      },
      ...
      html5Video: function (element) {
        CNVS.FullVideo &&
          CNVS.FullVideo.init(element ? element : ".video-wrap");
      },

      youtubeBgVideo: function (element) {
        CNVS.YoutubeBG &&
          CNVS.YoutubeBG.init(element ? element : ".yt-bg-player");
      },
      ...
      roundedSkills: function (element) {
        CNVS.RoundedSkills &&
          CNVS.RoundedSkills.init(element ? element : ".rounded-skill");
      },

      progress: function (element) {
        CNVS.Progress &&
          CNVS.Progress.init(element ? element : ".skill-progress");
      },
      ...
      instagram: function (element) {
        CNVS.Instagram &&
          CNVS.Instagram.init(element ? element : ".instagram-photos");
      },
      ...
      carousel: function (element) {
        CNVS.Carousel &&
          CNVS.Carousel.init(element ? element : ".carousel-widget");
      },

      masonryThumbs: function (element) {
        CNVS.MasonryThumbs &&
          CNVS.MasonryThumbs.init(element ? element : ".masonry-thumbs");
      },

      notifications: function (element) {
        CNVS.Notifications &&
          CNVS.Notifications.init(element ? element : false);
      },

      textRotator: function (element) {
        CNVS.TextRotator &&
          CNVS.TextRotator.init(element ? element : ".text-rotater");
      },

      onePage: function (element) {
        CNVS.OnePage &&
          CNVS.OnePage.init(
            element ? element : "[data-scrollto],.one-page-menu",
          );
      },
      ...
      subscribe: function (element) {
        CNVS.Subscribe &&
          CNVS.Subscribe.init(element ? element : ".subscribe-widget");
      },
      ...
      shapeDivider: function (element) {
        CNVS.ShapeDivider &&
          CNVS.ShapeDivider.init(element ? element : ".shape-divider");
      },

      stickySidebar: function (element) {
        CNVS.StickySidebar &&
          CNVS.StickySidebar.init(element ? element : ".sticky-sidebar-wrap");
      },

      cookies: function (element) {
        CNVS.Cookies &&
          CNVS.Cookies.init(
            element ? element : ".gdpr-settings,[data-cookies]",
          );
      },
      ...
      readmore: function (element) {
        CNVS.ReadMore &&
          CNVS.ReadMore.init(element ? element : "[data-readmore]");
      },

      pricingSwitcher: function (element) {
        CNVS.PricingSwitcher &&
          CNVS.PricingSwitcher.init(
            element ? element : ".pricing-tenure-switcher",
          );
      },

      ajaxTrigger: function (element) {
        CNVS.AjaxTrigger &&
          CNVS.AjaxTrigger.init(element ? element : "[data-ajax-loader]");
      },

      videoFacade: function (element) {
        CNVS.VideoFacade &&
          CNVS.VideoFacade.init(element ? element : ".video-facade");
      },

      schemeToggle: function (element) {
        CNVS.SchemeToggle &&
          CNVS.SchemeToggle.init(element ? element : ".body-scheme-toggle");
      },

      clipboardCopy: function (element) {
        CNVS.Clipboard &&
          CNVS.Clipboard.init(element ? element : ".clipboard-copy");
      },

      codeHighlight: function (element) {
        CNVS.CodeHighlight &&
          CNVS.CodeHighlight.init(element ? element : ".code-highlight");
      },
      ...
      textSplitter: function (element) {
        CNVS.TextSplitter &&
          CNVS.TextSplitter.init(element ? element : ".text-splitter");
      },

      mediaActions: function (element) {
        CNVS.MediaActions &&
          CNVS.MediaActions.init(element ? element : ".media-wrap");
      },

      viewportDetect: function (element) {
        CNVS.ViewportDetect &&
          CNVS.ViewportDetect.init(element ? element : ".viewport-detect");
      },

      scrollDetect: function (element) {
        CNVS.ScrollDetect &&
          CNVS.ScrollDetect.init(element ? element : ".scroll-detect");
      },

      fontSizer: function (element) {
        CNVS.FontSizer &&
          CNVS.FontSizer.init(element ? element : ".font-sizer");
      },
      ...
      buttons: function (element) {
        CNVS.Buttons &&
          CNVS.Buttons.init(element ? element : ".button-text-effect");
      },
  ...
  return {
    ...
    StickFooterOnSmall: (function () {
      return {
        init: function (selector) {
          ...
          if (
            !__core.getVars.elBody.classList.contains("sticky-footer") &&
            __core.getVars.elFooter !== "undefined" &&
          ...
          if (__core.getVars.elAppMenu) {
            if (
              __core.viewport().height -
                (__core.getVars.elAppMenu.getBoundingClientRect().top +
                  __core.getVars.elAppMenu.getBoundingClientRect().height) ===
              0
            ) {
              __core.getVars.elFooter.style.marginBottom =
                __core.getVars.elAppMenu.offsetHeight + "px";
            }
          }
    ...
    Headers: (function () {
      var _offset = function () {
        ...
        if (
          __core.getVars.elHeader?.classList.contains("floating-header") ||
          elHeaderInc?.classList.contains("include-topbar")
        ) {
          __core.getVars.headerOffset = __core.offset(elHeader).top;
        }
        __core.getVars.elHeaderWrap?.classList.add("position-absolute");
        __core.getVars.headerWrapOffset =
          __core.getVars.headerOffset + __core.getVars.elHeaderWrap?.offsetTop;
        ...
        if (elHeader.hasAttribute("data-sticky-offset")) {
          ...
          if (headerDefinedOffset == "full") {
            ...
            var headerOffsetNegative = elHeader.getAttribute(
              "data-sticky-offset-negative",
            );
            if (typeof headerOffsetNegative !== "undefined") {
              if (headerOffsetNegative == "auto") {
                __core.getVars.headerWrapOffset =
                  __core.getVars.headerWrapOffset - elHeader.offsetHeight - 1;
              } else {
                __core.getVars.headerWrapOffset =
                  __core.getVars.headerWrapOffset -
                  Number(headerOffsetNegative) -
                  1;
              }
            }
          } else {
      ...
      var _sticky = function (stickyOffset) {
        if (
          !__core.getVars.elBody.classList.contains("is-expanded-menu") &&
          __core.getVars.mobileSticky != "true"
        ) {
          return true;
        }
          ...
          if (!__core.getVars.elBody.classList.contains("side-header")) {
            ...
            if (
              ...
              if (
                ...
                Number(__core.getVars.stickyShrinkOffset)
              ) {
                __core.getVars.elHeader.classList.add("sticky-header-shrink");
              } else {
                __core.getVars.elHeader.classList.remove(
      ...
      var _removeSticky = function () {
        ...
        if (__core.getVars.elHeaderWrap) {
          __core.getVars.elHeaderWrap.className =
            __core.getVars.headerWrapClasses;
        }
        if (
          !__core.getVars.elHeaderWrap?.classList.contains("force-not-dark")
        ) {
        ...
        if (noOfNewClasses > 0) {
          ...
          for (i = 0; i < noOfNewClasses; i++) {
            if (newClassesArray[i] == "not-dark") {
              ...
              if (
                !__core.getVars.elHeaderWrap?.classList.contains(".not-dark")
              ) {
              ...
              if (
                !__core.getVars.elHeader.classList.contains(newClassesArray[i])
              ) {
      ...
      var _includeHeader = function () {
        ...
        if (
          elHeader.classList.contains("floating-header") ||
          elHeaderInc.classList.contains("include-topbar")
        ) {
      ...
      var _sideHeader = function () {
        ...
        if (headerTrigger) {
          headerTrigger.onclick = function (e) {
            e.preventDefault();
            __core.getVars.elBody.classList.contains("open-header") &&
              __core.getVars.elBody.classList.toggle("side-header-open");
          };
        }
      };
      ...
      return {
        init: function (selector) {
          ...
          __core.getVars.stickyHeaderClasses =
            elHeader.getAttribute("data-sticky-class");
          __core.getVars.mobileHeaderClasses = elHeader.getAttribute(
            "data-responsive-class",
          );
          __core.getVars.stickyShrink =
            elHeader.getAttribute("data-sticky-shrink") || "true";
          __core.getVars.stickyShrinkOffset =
            elHeader.getAttribute("data-sticky-shrink-offset") || 300;
          __core.getVars.mobileSticky =
            elHeader.getAttribute("data-mobile-sticky") || "false";
          __core.getVars.headerHeight = elHeader.offsetHeight;
          ...
          if (!headerWrapClone) {
            ...
            __core.getVars.elHeaderWrap?.parentNode.insertBefore(
              headerWrapClone,
              __core.getVars.elHeaderWrap?.nextSibling,
            );
    ...
    Menus: (function () {
      var _init = function () {
        __core.getVars.headerWrapHeight =
          __core.getVars.elHeaderWrap?.offsetHeight;

        var onClickMenus = [].slice
          .call(__core.getVars.elPrimaryMenus)
        ...
        document.querySelectorAll(".menu-item").forEach(function (el) {
          ...
          if (
            !el.classList.contains("mega-menu-title") &&
            el.querySelectorAll(".sub-menu-container").length > 0 &&
            el.querySelectorAll(".sub-menu-trigger").length < 1
          ) {
            var subMenuTrigger = document.createElement("button");
            subMenuTrigger.classList =
      ...
      var _reset = function () {
        ...
        __core.getVars.elPrimaryMenus.forEach(function (el) {
          if (!body.classList.contains("is-expanded-menu")) {
            ...
            el.querySelector(".menu-container")?.classList.remove(
              "d-block",
              "d-none",
            );
            ...
            __core.getVars.elPrimaryMenus.forEach(function (el) {
              el.querySelectorAll(".mobile-primary-menu")?.forEach(
                function (elem) {
      ...
      var _arrows = function () {
        var addArrow = function (menuItemDiv) {
          if (
            menuItemDiv &&
            !menuItemDiv.querySelector(".sub-menu-indicator")
          ) {
            ...
            var customArrow =
              menuItemDiv
                ...
                ?.getAttribute("data-arrow-class") || "fa-solid fa-caret-down";
            customArrow &&
              customArrow.split(" ").forEach(function (className) {
        ...
        document
          ...
          .forEach(function (menuItem) {
            ...
            ) && addArrow(menuItemDiv);
          });

        // Arrows for Primary Menu Items
        document.querySelectorAll(".menu-item").forEach(function (menuItem) {
          var menuItemDiv = menuItem.querySelector(":scope > .menu-link > div");
          !menuItem.classList.contains("mega-menu-title") &&
            menuItem.querySelector(
        ...
        document
          .querySelectorAll(".page-menu-item")
          .forEach(function (menuItem) {
            var menuItemDiv = menuItem.querySelector(":scope > a > div");
            menuItem.querySelector(":scope > .page-menu-sub-menu") &&
              addArrow(menuItemDiv);
          });
      };
      ...
      var _invert = function (subMenuEl) {
        ...
        subMenus.forEach(function (el) {
          ...
          if (el.closest(".mega-menu-small")) {
            var outside =
              __core.viewport().width -
              (viewportOffset.left + viewportOffset.width);
            if (outside < 0) {
      ...
      var _hover = function () {
        ...
        var menuHoverDelay =
          getComputedStyle(__core.getVars.elHeader).getPropertyValue(
      ...
      var _functions = function () {
        ...
        var triggers = [].slice
          .call(triggersBtn)
          .concat([].slice.call(triggerLinks));
          ...
          triggers.forEach(function (trigger) {
            trigger.onclick = function (e) {
              ...
              if (!trigger.classList.contains("sub-menu-trigger")) {
                triggerEl = trigger
                  .closest(menuItemSel)
                  .querySelector(":scope > " + subMenuTriggerSel);
              }

              __core
                .siblings(triggerEl.closest(menuItemSel))
                .forEach(function (item) {
              ...
              if (triggerEl.closest(".mega-menu-content")) {
                ...
                __core.parents(triggerEl, menuItemSel).forEach(function (item) {
                  parentSubMenuContainers.push(
                    item.querySelector(":scope > " + subMenusSel),
                  );
                });
                ...
                [].slice
                  .call(
                    triggerEl
                      .closest(".mega-menu-content")
                      .querySelectorAll(subMenusSel),
                  )
        ...
        if (body.contains("is-expanded-menu")) {
          if (body.contains("side-header") || body.contains("overlay-menu")) {
            __core.getVars.elPrimaryMenus.forEach(function (pMenu) {
              ...
              pMenu
                .querySelectorAll(subMenuTriggerSel)
                .forEach(function (item) {
                  item.style.zIndex = "-1";
                });
            });
          ...
          [].slice
            ...
            .forEach(function (pMenu) {
              var menuItemSubs = __core.has(
                pMenu.querySelectorAll(menuItemSel),
                subMenuTriggerSel,
              );
        ...
        document.querySelectorAll(".top-links").forEach(function (item) {
          if (
            item.classList.contains("on-click") ||
            !body.contains("device-up-lg")
          ) {
            item
              .querySelectorAll(".top-links-item")
              .forEach(function (menuItem) {
      ...
      var _triggerState = function (
        ...
        var triggerredSubMenus = triggerEl
          .closest(menuItemSel)
          .querySelector(":scope > " + subMenusSel);
        var childSubMenus = triggerEl
          .closest(menuItemSel)
          .querySelectorAll(subMenusSel);
      ...
      var _current = function (
        ...
        [].slice
          .call(
            triggerEl.closest(".menu-container").querySelectorAll(menuItemSel),
          )
          .forEach(function (item) {
            item.classList.remove("current");
          });
        ...
        document
          ...
          .forEach(function (menuTrigger) {
            menuTrigger.onclick = function (e) {
              ...
              if (
                __core.filtered(__core.getVars.elPrimaryMenus, elTarget)
                  .length < 1
              ) {
                return;
              }
              ...
              __core.getVars.elPrimaryMenus.forEach(function (elem) {
                elem.matches(elTarget) &&
                  elem.classList.toggle("primary-menu-active");
              });
              ...
              if (elTarget != "*") {
                body.toggle(
                  "primary-menu-open-" + elTarget.replace(/[^a-zA-Z0-9-]/g, ""),
                );
              } else {
      ...
      var _fullWidth = function () {
        ...
        if (
          __core.getVars.elHeader.querySelectorAll(".container-fullwidth")
            .length > 0
        ) {
          document
            .querySelectorAll(
        ...
        if (__core.getVars.elHeader.classList.contains("floating-header")) {
          var floatingHeaderPadding = getComputedStyle(
          ...
          document
            ...
            .forEach(function (el) {
              el.style.width =
                headerWidth +
                Number(floatingHeaderPadding.split("px")[0]) * 2 +
                "px";
            });
        }
      };
      ...
      return {
        init: function (selector) {
          ...
          if (!pageMenuClone) {
            ...
            pageMenuWrap.parentNode.insertBefore(
              pageMenuClone,
              pageMenuWrap.nextSibling,
            );
            pageMenuClone = pageMenu.querySelector(".page-menu-wrap-clone");
          }

          pageMenuClone.style.height =
            pageMenu.querySelector("#page-menu-wrap").offsetHeight + "px";
          ...
          if (
            pageMenu.classList.contains("no-sticky") ||
            pageMenu.classList.contains("dots-menu")
          ) {
            return true;
          }
          ...
          if (__core.getVars.elHeader.classList.contains("no-sticky")) {
            ...
            __core.getVars.elHeader.getAttribute("data-sticky-shrink") ==
            "false"
          ) {
            headerHeight = getComputedStyle(__core.getVars.elHeader)
              .getPropertyValue("--cnvs-header-height")
              .split("px")[0];
          } else {
            headerHeight = getComputedStyle(__core.getVars.elHeader)
              .getPropertyValue("--cnvs-header-height-shrink")
              .split("px")[0];
          }

          pageMenu.style.setProperty(
            "--cnvs-page-submenu-sticky-offset",
            headerHeight + "px",
          );

          setTimeout(function () {
            __core.getVars.pageMenuOffset =
              __core.offset(pageMenu).top - headerHeight;
      ...
      return {
        init: function (selector) {
          ...
          var slider = document.querySelector(".slider-element"),
            ...
            slFlexHeight =
              slider.classList.contains("h-auto") ||
              slider.classList.contains("min-vh-0");
          ...
          if (body.classList.contains("device-up-lg")) {
            ...
            if (slFlexHeight && slSwiperS) {
              ...
              if (
                slSwiperFC.classList.contains("container") ||
                slSwiperFC.classList.contains("container-fluid")
              ) {
    ...
    SliderMenuClass: (function () {
      var _swiper = function () {
        if (
          !__core.getVars.elHeader.classList.contains("ignore-slider") &&
          (__core.getVars.elBody.classList.contains("is-expanded-menu") ||
            (__core.getVars.elHeader.classList.contains(
              "transparent-header-responsive",
            ) &&
              !__core.getVars.elBody.classList.contains("primary-menu-open")))
        ) {
          var activeSlide = __core.getVars.elSlider.querySelector(
            ".swiper-slide-active",
          );
      ...
      var _revolution = function () {
        if (
          ...
          var activeSlide =
            __core.getVars.elSlider.querySelector(".active-revslide");
          _schemeChanger(activeSlide);
        }
      };
      ...
      var _schemeChanger = function (activeSlide) {
        ...
        if (activeSlide.classList.contains("dark")) {
          ...
          var headerToChange = document.querySelector(
      ...
      return {
        init: function (selector) {
          ...
          selector[0].onclick = function (e) {
            ...
            __core.getVars.elPageMenu &&
              __core.getVars.elPageMenu.classList.remove("page-menu-open");
          ...
          document
            ...
            .forEach(function (el) {
              el.onclick = function (e) {
                ...
                if (
                  body.contains("device-touch") &&
                  body.contains("side-push-panel")
                ) {
                  body.toggle("ohidden");
                }
              };
    ...
    AdaptiveColorScheme: (function () {
      return {
        init: function (selector) {
          ...
          var adaptiveEl = document.querySelector(
          ...
          if (__core.getVars.elBody.contains(adaptiveEl)) {
            adaptLightClass = adaptiveEl.getAttribute(
              "data-adaptive-light-class",
            );
            adaptDarkClass = adaptiveEl.getAttribute(
    ...
    PortfolioAjax: (function () {
      var _newNextPrev = function (portPostId) {
        ...
        if (!document.getElementById("prev-portfolio") && portPrev) {
          ...
          prevPortItem &&
            portNav?.insertBefore(
              prevPortItem,
              document.getElementById("close-portfolio"),
            );
        }
      ...
      var _load = function (portPostId, prevPostPortId, getIt) {
        ...
        if (getIt == false) {
          ...
          var portfolioDataLoader = document
            .getElementById(portPostId)
      ...
      var _close = function () {
        if (
          __core.getVars.portfolioAjax.wrapper &&
          __core.getVars.portfolioAjax.wrapper.offsetHeight > 32
        ) {
          __core.getVars.elBody.classList.remove("portfolio-ajax-loading");
          // __core.getVars.portfolioAjax.loader.classList.add('loader-overlay-display');
          __core.getVars.portfolioAjax.wrapper.classList.remove(
      ...
      var _open = function () {
        var countImages =
          __core.getVars.portfolioAjax.container.querySelectorAll("img").length;

        if (countImages < 1) {
          _display();
        } else {
          __core.imagesLoaded(__core.getVars.portfolioAjax.container);
          __core.getVars.portfolioAjax.container.addEventListener(
            "CanvasImagesLoaded",
            function () {
              _display();
            },
      ...
      var _display = function () {
        ...
        __core.getVars.portfolioAjax.wrapper.classList.add(
          "portfolio-ajax-opened",
        );
        __core.getVars.elBody.classList.remove("portfolio-ajax-loading");
        ...
        setTimeout(function () {
          ...
          __core.scrollTo(
            __core.getVars.portfolioAjax.wrapperOffset -
              __core.getVars.topScrollOffset -
              60,
            false,
            false,
          );
      ...
      var _getPrev = function (portPostId) {
        var portPrev = false;
        var hasPrev =
          document.getElementById(portPostId).previousElementSibling;
      ...
      var _initAjax = function (portPostId) {
        __core.getVars.portfolioAjax.prevItem =
          document.getElementById(portPostId);
      ...
      return {
        init: function (selector) {
          ...
          __core.getVars.portfolioAjax.items =
            selector[0].querySelectorAll(".portfolio-item");
          __core.getVars.portfolioAjax.wrapper = document.getElementById(
            "portfolio-ajax-wrap",
          );
          __core.getVars.portfolioAjax.wrapperOffset = __core.offset(
            __core.getVars.portfolioAjax.wrapper,
          ).top;
          __core.getVars.portfolioAjax.container = document.getElementById(
            "portfolio-ajax-container",
          );
          __core.getVars.portfolioAjax.loader = document.getElementById(
        ...
        init: function (selector) {
          ...
          if (elLoaderColor) {
            if (elLoaderColor == "theme") {
              ...
              elLoaderCSSVar =
                ' style="--cnvs-loader-color:' + elLoaderColor + ';"';
            }
          }

          var elLoaderBefore =
              '<div class="css3-spinner"' + elLoaderCSSVar + ">",
            elLoaderAfter = "</div>";
          ...
          if (elSpeedIn) {
            __core.getVars.elWrapper.style.setProperty(
          ...
          var endPageTransition = function () {
            ...
            var displayContent = function () {
              ...
              setTimeout(function () {
                __core.getVars.elWrapper.style.removeProperty(
                  "--cnvs-animate-duration",
                );
              }, 666);
            };
            ...
            __core.getVars.elWrapper.addEventListener(
              "transitionend",
              displayContent,
            );
            __core.getVars.elWrapper.addEventListener(
            ...
            .then(function (cond) {
              ...
              window.lazyLoadInstance = new LazyLoad({
                ...
                callback_loaded: function (el) {
                  ...
                  if (
                    el.parentNode.getAttribute("data-lazy-container") == "true"
                  ) {
          ...
          selector.forEach(function (el) {
            ...
            if (classes.length > 0) {
              classes.forEach(function (_class) {
                ...
                if (
                  __core.getVars.elBody.classList.contains(
                    deviceClass[0] == "dark"
                      ? deviceClass[0]
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                var element = jQuery(this),
                  ...
                  elCloseButton =
                    element.attr("data-close-button") || "outside",
                  elDisableUnder = element.attr("data-disable-under") || 600,
                  elFixedContent =
                    element.attr("data-content-position") || "auto",
                ...
                if (elType == "gallery") {
                  ...
                  element.magnificPopup({
                    delegate: element.hasClass("grid-container-filterable")
                ...
                element.on("mfpOpen", function () {
                  var lightboxItem = jQuery.magnificPopup.instance.currItem.el,
                    lightboxClass = jQuery(lightboxItem).attr(
                      "data-lightbox-class",
                    ),
                    lightboxBgClass = jQuery(lightboxItem).attr(
                      "data-lightbox-bg-class",
                    );

                  if (lightboxClass != "") {
                    jQuery(jQuery.magnificPopup.instance.container).addClass(
                      lightboxClass,
                    );
                  }

                  if (lightboxBgClass != "") {
                    jQuery(jQuery.magnificPopup.instance.bgOverlay).addClass(
                      lightboxBgClass,
                    );
                  }
                });
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                  ...
                  jQuery.magnificPopup.open(
                    {
                      ...
                      callbacks: {
                        open: function () {
                          if (elAnimateIn != "") {
                            jQuery(elTarget).addClass(
                              elAnimateIn + " animated",
                            );
                          }
                        },
                        beforeClose: function () {
                          if (elAnimateOut != "") {
                            jQuery(elTarget)
                              .removeClass(elAnimateIn)
                              .addClass(elAnimateOut);
                          }
                        },
                        afterClose: function () {
                          if (elAnimateIn != "" || elAnimateOut != "") {
                            jQuery(elTarget).removeClass(
                              elAnimateIn + " " + elAnimateOut + " animated",
                            );
                          }
                        },
                      },
                ...
                if (document.querySelector(".modal-cookies-close")) {
                  document.querySelector(".modal-cookies-close").onclick =
                    function () {
    ...
    HoverAnimations: (function () {
      ...
      var _hideOverlay = function (params) {
        ...
        (params.elAnimate + " not-animated")
          .split(" ")
          .forEach(function (_class) {
            params.element.classList.remove(_class);
          });

        (params.elAnimateOut + " animated")
          .split(" ")
          .forEach(function (_class) {
            params.element.classList.add(_class);
          });
        ...
        init: function (selector) {
          ...
          selector.forEach(function (element) {
            var elAnimate = element.getAttribute("data-hover-animate"),
              elAnimateOut =
                element.getAttribute("data-hover-animate-out") || "fadeOut",
      ...
      return {
        init: function (selector) {
          ...
          __core
            .isFuncTrue(function () {
              return (
                typeof jQuery !== "undefined" && typeof Isotope !== "undefined"
              );
            })
            .then(function (cond) {
              if (!cond) {
              ...
              selector.each(function () {
                ...
                if (
                  ...
                  element.hasClass("post-timeline")
                ) {
                ...
                var int = setInterval(function () {
                  if (
                    element.find(".lazy.lazy-loaded").length ==
                    element.find(".lazy").length
                  ) {
                    setTimeout(function () {
                      _reLayout(element);
                    }, 666);
            ...
            .then(function (cond) {
              ...
              selector.forEach(function (element) {
                ...
                var elDirection =
                  ...
                  elAutoPlayDisableOnInteraction =
                  ...
                  slideNumberTotal = element.querySelector(
                    ".slide-number-total",
                  ),
                  slideNumberCurrent = element.querySelector(
                ...
                elAutoPlayDisableOnInteraction =
                  elAutoPlayDisableOnInteraction == "false" ? false : true;
                ...
                var cnvsSwiper = new Swiper(
                  element.querySelector(".swiper-parent"),
                  {
                    ...
                    on: {
                      afterInit: function (swiper) {
                        ...
                        if (
                          element.querySelectorAll(".yt-bg-player").length > 0
                        ) {
                          element
                      ...
                      transitionEnd: function (swiper) {
                        ...
                        element
                          ...
                          .forEach(function (slide) {
                            ...
                            var activeYTPlayer = slide.querySelector(
                              ".yt-bg-player.mb_YTPlayer:not(.customjs)",
                            );

                            if (activeYTPlayer) {
                              jQuery(activeYTPlayer).YTPSeekTo(
                                activeYTPlayer.getAttribute("data-start"),
                              );
                            }
                          });
                ...
                if (slideNumberTotal) {
                  slideNumberTotal.innerHTML = element.querySelectorAll(
                    ".swiper-slide:not(.swiper-slide-duplicate)",
                  ).length;
                }
              });
    ...
    SliderParallax: (function () {
      ...
      var _parallax = function (_settings) {
        ...
        fastdom.measure(function () {
          ...
          if (
            _settings.body.classList.contains("is-expanded-menu") &&
            !_settings.isMobile
          ) {
            if (
              _settings.height + _settings.sliderPx.offset + 50 >
              _settings.scrollPos.y
            ) {
              ...
              if (_settings.scrollPos.y > _settings.sliderPx.offset) {
                if (
                  typeof _settings.sliderPx.el.querySelector(
                    ".slider-inner",
                  ) === "object"
                ) {
                  _transform =
                    (_settings.scrollPos.y - _settings.sliderPx.offset) * -0.4;
                  _transform2 =
                    (_settings.scrollPos.y - _settings.sliderPx.offset) * -0.15;

                  _setParallax(0, _transform, _settings.sliderPx.inner);
                  _setParallax(0, _transform2, _settings.sliderPx.caption);
                } else {
                  _transform =
                    (_settings.scrollPos.y - _settings.sliderPx.offset) / 1.5;
                  _transform2 =
                    (_settings.scrollPos.y - _settings.sliderPx.offset) / 7;
      ...
      var _offset = function () {
        ...
        if (
          __core.getVars.elBody.classList.contains("side-header") ||
          (__core.getVars.elHeader &&
            __core.getNext(__core.getVars.elHeader, ".include-header").length >
              0)
        ) {
          headerHeight = 0;
        }
      ...
      var _elementFade = function (_settings) {
        ...
        fastdom.mutate(function () {
          if (
            ...
            if (
              (_settings.header &&
                _settings.header.classList.contains("transparent-header")) ||
              _settings.body.classList.contains("side-header")
            ) {
              tHeaderOffset = 100;
            } else {
              tHeaderOffset = 0;
            ...
            if (
              _settings.sliderPx.el.classList.contains(
                "slider-parallax-visible",
              )
            ) {
              _settings.sliderPx.el
                .querySelectorAll(
                ...
                .forEach(function (el) {
                  el.style.opacity =
                    1 -
                    ((_settings.scrollPos.y - tHeaderOffset) * 1.85) /
                      _settings.height;
                });
            }
          } else {
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                var element = jQuery(this),
                  ...
                  elArrowLeft =
                    element.attr("data-arrow-left") || "uil uil-angle-left-b",
                  elArrowRight =
                    element.attr("data-arrow-right") || "uil uil-angle-right-b",
                ...
                element.find(".flexslider").flexslider({
                  ...
                  start: function (slider) {
                    ...
                    jQuery(".flex-prev").html(
                      '<i class="' + elArrowLeft + '"></i>',
                    );
                    jQuery(".flex-next").html(
                      '<i class="' + elArrowRight + '"></i>',
                    );
                    setTimeout(function () {
                      if (
                  ...
                  after: function (slider) {
                    if (
                      slider.parents(".grid-container.has-init-isotope")
                        .length > 0 &&
                      !slider.hasClass("flexslider-grid-relayout")
                    ) {
                      slider
                        .parents(".grid-container.has-init-isotope")
                        .isotope("layout");
        ...
        init: function (selector) {
          ...
          selector.forEach(function (element) {
            ...
            if (
              ...
              !element.classList.contains("no-placeholder")
            ) {
              var placeholderImg =
                elVideo.getAttribute("poster") ||
                elVideo.getAttribute("data-poster");
        ...
        init: function (selector) {
          ...
          __core
            ...
            .then(function (cond) {
              ...
              selector = __core.getSelector(
                selector,
                true,
                ".mb_YTPlayer,.customjs",
              );
              if (selector.length < 1) {
                return true;
              }
          ...
          __core
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                ...
                if (elState != "closed") {
                  element
                    .find(".accordion-header:eq(" + Number(elActive) + ")")
                    .addClass("accordion-active " + elActiveClass)
                    .next()
                    .show();
                }
                ...
                element
                  ...
                  .on("click", function () {
                    ...
                    if (clickTarget.next().is(":hidden")) {
                      element
                        .find(".accordion-header")
                        .removeClass("accordion-active " + elActiveClass)
                        .next()
                        .slideUp("normal");
                      clickTarget
                        .toggleClass("accordion-active " + elActiveClass, true)
                        .next()
                        .stop(true, true)
                      ...
                      if (elCollapsible == "true") {
                        clickTarget
                          .toggleClass(
                            "accordion-active " + elActiveClass,
                            false,
                          )
                          .next()
                          .stop(true, true)
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                ...
                if (elMonth && elMonth < 13) {
                  dateFormat =
                    dateFormat + "-" + (elMonth < 10 ? "0" + elMonth : elMonth);
                } else {
                  if (elYear) {
                ...
                if (elDay && elDay < 32) {
                  dateFormat =
                    dateFormat + "-" + (elDay < 10 ? "0" + elDay : elDay);
                } else {
                  if (elYear) {
                    dateFormat = dateFormat + "-01";
                  }
                ...
                setDate =
                  dateFormat != "" ? new Date(moment(dateFormat)) : new Date();
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                var element = jQuery(this),
                  ...
                  elConStreetV =
                    element.attr("data-control-streetview") || false,
                  elConOverview =
                    element.attr("data-control-overview") || false;
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                var element = jQuery(this),
                  ...
                  elTrackColor =
                    element.attr("data-trackcolor") || "rgba(0,0,0,0.04)";
    ...
    Twitter: (function () {
      var _build = function (tweet, element, username) {
        var elFontClass =
          element.getAttribute("data-font-class") || "font-body";
        ...
        init: function (selector) {
          ...
          selector.forEach(function (element) {
            var elUser = element.getAttribute("data-username") || "twitter",
              ...
              elLoader =
                element.getAttribute("data-loader") ||
                "include/twitter/tweets.php",
              elFetch =
                element.getAttribute("data-fetch-message") ||
            ...
            fetch(elLoader + "?username=" + elUser)
              .then(function (response) {
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                ...
                element
                  ...
                  .append('<i class="sub-menu-indicator ' + elArrow + '"></i>');
                  ...
                  element.find("ul li:has(ul):not(.active)").hover(
                    function (e) {
                      jQuery(this)
                        .children("ul")
                        .stop(true, true)
                        .slideDown(Number(elSpeed), elEasing);
                    },
                    function () {
                      jQuery(this)
                        .children("ul")
                        .delay(250)
                        .slideUp(Number(elSpeed), elEasing);
                    },
                  );
                } else {
                  element
                    ...
                    .on("click", function () {
                      ...
                      childElement
                        .parent()
                        .children("ul")
                        .slideToggle(Number(elSpeed), elEasing, function () {
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                var element = jQuery(this),
                  ...
                  elItemsSm =
                    element.attr("data-items-sm") || Number(elItemsXs),
                  elItemsMd =
                    element.attr("data-items-md") || Number(elItemsSm),
                  elItemsLg =
                    element.attr("data-items-lg") || Number(elItemsMd),
                  elItemsXl =
                    element.attr("data-items-xl") || Number(elItemsLg),
                  elItemsXxl =
                    element.attr("data-items-xxl") || Number(elItemsXl),
                  ...
                  elNavPrev =
                    element.attr("data-nav-prev") ||
                    '<i class="uil uil-angle-left-b"></i>',
                  elNavNext =
                    element.attr("data-nav-next") ||
                ...
                var carousel = element.owlCarousel({
                  ...
                  onInitialized: function () {
                    __base.sliderDimensions(
                      element.parents(".slider-element")[0],
                    );
          ...
          __core
            ...
            .then(function (cond) {
              ...
              selector.each(function () {
                ...
                var firstElementWidth = Number(
                  compStyle.getPropertyValue("width").split("px")[0],
                );
          ...
          __core
            ...
            .then(function (cond) {
              ...
              var element = selector,
                elPosition =
                  element.attr("data-notify-position") || "top-right",
                elType = element.attr("data-notify-type"),
                elMsg =
                  element.attr("data-notify-msg") || "Please set a message!",
    ...
    OnePage: (function () {
      var _init = function (selector) {
        ...
        if (__core.getVars.elOnePageMenus) {
          __core.getVars.elOnePageMenus.forEach(function (onePageMenu) {
            __core.getVars.elOnePageActiveClass =
              onePageMenu.getAttribute("data-active-class") || "current";
            __core.getVars.elOnePageParentSelector =
              onePageMenu.getAttribute("data-parent") || "li";
            __core.getVars.elOnePageActiveOnClick =
              onePageMenu.getAttribute("data-onclick-active") || "false";
      ...
      var _hash = function () {
        ...
        if (
          document.querySelector(
            'a[data-href="' + __core.getVars.hash + '"]',
          ) ||
          document.querySelector(
            'a[data-scrollto="' + __core.getVars.hash + '"]',
          )
        ) {
          ...
          if (section) {
            var int = setInterval(function () {
              var settings =
                section.getAttribute("data-onepage-settings") &&
      ...
      var _getSettings = function (el, type) {
        ...
        setTimeout(function () {
          ...
          __core.getVars.pageSectionEls = document.querySelectorAll(
            "[data-onepage-settings]",
          );
        }, 1000);
      };
      ...
      var _scroller = function (el, type, clicker = false) {
        ...
        if (
          type != "scrollTo" &&
          __core.getVars.elOnePageActiveOnClick == "true"
        ) {
          parent = el.closest(".one-page-menu");

          parent
            .querySelectorAll(__core.getVars.elOnePageParentSelector)
            .forEach(function (el) {
              el.classList.remove(__core.getVars.elOnePageActiveClass);
            });

          parent
            .querySelector('a[data-href="#' + sectionId + '"]')
            .closest(__core.getVars.elOnePageParentSelector)
            .classList.add(__core.getVars.elOnePageActiveClass);
        }

        if (
          !__core.getVars.elBody.classList.contains("is-expanded-menu") ||
          __core.getVars.elBody.classList.contains("overlay-menu")
        ) {
          __core.getVars.recalls.menureset();
        }
      ...
      var _scroll = function (section, settings, timeout) {
        setTimeout(function () {
          ...
          __core.scrollTo(
            sectionOffset - Number(settings.offset),
            settings.speed,
            settings.easing,
          );
        }, Number(timeout));
      ...
      var _position = function () {
        __core.getVars.elOnePageMenus &&
          __core.getVars.elOnePageMenus.forEach(function (el) {
            el.querySelectorAll("[data-href]").forEach(function (item) {
              item
                .closest(__core.getVars.elOnePageParentSelector)
                .classList.remove(__core.getVars.elOnePageActiveClass);
            });
          });

        __core.getVars.elOnePageMenus &&
          __core.getVars.elOnePageMenus.forEach(function (el) {
            el.querySelector('[data-href="#' + _current() + '"]')
              ?.closest(__core.getVars.elOnePageParentSelector)
              .classList.add(__core.getVars.elOnePageActiveClass);
          });
      };
      ...
      var _current = function () {
        ...
        __core.getVars.pageSectionEls.forEach(function (el) {
          var settings =
            el.getAttribute("data-onepage-settings") &&
          ...
          if (settings) {
            ...
            if (
              y >= h &&
              y < h + el.offsetHeight &&
              el.getAttribute("id") != currentOnePageSection &&
              el.getAttribute("id")
            ) {
      ...
      var _settings = function (section, element, json = true) {
        ...
        parentSettings.offset =
          parent?.getAttribute("data-offset") || defaults.offset;
        parentSettings.speed =
          parent?.getAttribute("data-speed") || defaults.speed;
        parentSettings.easing =
          parent?.getAttribute("data-easing") || defaults.easing;
                    ...
                    jQuery(form).ajaxSubmit({
                      ...
                      success: function (data) {
                        ...
                        if (data.alert != "error") {
                          ...
                          var rangeSlider = jQuery(form).find(
                            ".input-range-slider",
                          );
                          ...
                          $body
                            .removeClass(elFormId + "-error")
                            .addClass(elFormId + "-success");
                        } else {
                          jQuery(form).trigger("formSubmitError", data);
                          $body
                            .removeClass(elFormId + "-success")
                            .addClass(elFormId + "-error");
                        }

                        if (elFormId) {
                          $body
                            .removeClass(elFormId + "-processing")
                            .addClass(elFormId + "-complete");
                        }

                        if (
                          jQuery(form).find(".g-recaptcha").children("div")
                            .length > 0
                        ) {
                          grecaptcha.reset();
                        }
        ...
        init: function (selector) {
          ...
          selector.forEach(function (el) {
            var field = el,
              ...
              conditionCheck =
                field.getAttribute("data-condition-check") || "value",
    ...
    Cookies: (function () {
      ...
      return {
        init: function (selector) {
          ...
          if (cookieBar) {
            if (
              cookieBar?.classList.contains("gdpr-settings-sm") &&
              cookieBar?.classList.contains("gdpr-settings-right")
            ) {
              elDirection = "right";
          ...
          var acceptCookies = __core.cookie.get("__cnvs_cookies_accept"),
            ...
            cookiesAllowed =
              (acceptCookies || acceptCookies != "0") &&
              (!declineCookies || declineCookies != "1");
          ...
          if (gdprSaveCookies.length > 0) {
            gdprSaveCookies.forEach(function (btn) {
              btn.onclick = function (e) {
                ...
                elSwitches.forEach(function (el) {
                  var elCookie =
                    "__cnvs_gdpr_" + el.getAttribute("data-cookie-name");
          ...
          document
            ...
            ?.forEach(function (element) {
              var elCookie =
                  "__cnvs_gdpr_" + element.getAttribute("data-cookie-name"),
                elContent = element.getAttribute("data-cookie-content"),
                elContentAjax = element.getAttribute(
                  "data-cookie-content-ajax",
                ),
                getCookie = __core.cookie.get(elCookie);
                ...
                if (elContentAjax) {
                  fetch(elContentAjax)
                    ...
                    .then(function (html) {
                      ...
                      var parsedHTML = domParser.parseFromString(
                        html,
                        "text/html",
                      );
        ...
        init: function (selector) {
          ...
          selector.forEach(function (el) {
            var element = el,
              ...
              elScrollUp =
                element.getAttribute("data-readmore-scrollup") || "false",
              elTrigger =
                element.getAttribute("data-readmore-trigger") ||
                ".read-more-trigger",
              elTriggerO =
                element.getAttribute("data-readmore-trigger-open") ||
                "Read More",
              elTriggerC =
                element.getAttribute("data-readmore-trigger-close") ||
                "Read Less",
              elMask;
            ...
            var elMaskD = element.getAttribute("data-readmore-mask") || "true",
              elMaskColor =
                element.getAttribute("data-readmore-maskcolor") || "#FFF",
              elMaskSize =
                element.getAttribute("data-readmore-masksize") || "100%";

            if (elMaskD == "true") {
              elMask.style.height = elMaskSize;
              elMask.style.backgroundImage =
                "linear-gradient( " +
                _HEXtoRGBA(elMaskColor, 0) +
                ", " +
                _HEXtoRGBA(elMaskColor, 1) +
                " )";
            ...
            elTriggerEl.onclick = function (e) {
              ...
              if (element.classList.contains("read-more-wrap-open")) {
                ...
                setTimeout(function () {
                  if (elScrollUp == "true") {
                    __core.scrollTo(
                      element.offsetTop - __core.getVars.topScrollOffset,
                      false,
                      false,
                    );
                  }
    ...
    PricingSwitcher: (function () {
      ...
      var _switcher = function (check, switcher, pricing, defClass, actClass) {
        ...
        pricing
          .querySelectorAll(".pts-content-" + value)
          .forEach(function (el) {
      ...
      return {
        init: function (selector) {
          ...
          selector.forEach(function (element) {
            var elCheck = element.querySelectorAll(
                '[type="checkbox"], [type="radio"], select',
              ),
              elDefClass =
                element.getAttribute("data-default-class") ||
                "text-muted op-05",
              elActClass =
                element.getAttribute("data-active-class") || "fw-bold",
              elPricing = document.querySelector(
                element.getAttribute("data-container"),
              );
        ...
        fetch(params.loader)
          ...
          .then(function (html) {
            ...
            if (params.placement == "append") {
              params.container?.insertAdjacentHTML(
                "beforeend",
                parsedHTML.body.innerHTML,
              );
            } else {
          ...
          selector.forEach(function (el) {
            var params = {
              ...
              container: document.querySelector(
                el.getAttribute("data-ajax-container"),
              ),
              contentPlacement:
                el.getAttribute("data-ajax-insertion") || "append",
              triggerHide: el.getAttribute("data-ajax-trigger-hide") || "true",
              triggerDisable:
                el.getAttribute("data-ajax-trigger-disable") || "true",
          ...
          selector.forEach(function (element) {
            element.onclick = function (e) {
              ...
              var videoContent = element.getAttribute("data-video-html"),
                videoRatio =
                  element.getAttribute("data-video-ratio") ||
                  "ratio ratio-16x9",
    ...
    SchemeToggle: (function () {
      var _toggle = function (element, sibling = false, action = false) {
        var bodyClassToggle =
          element.getAttribute("data-bodyclass-toggle") || "dark";
        var classAdd =
          element.getAttribute("data-add-class") || "scheme-toggler-active";
        var classRemove =
          element.getAttribute("data-remove-class") || "scheme-toggler-active";
            ...
            .then(function (cond) {
              ...
              selector.forEach(function (el) {
                var trigger = el.querySelector("button"),
                  ...
                  copiedTimeout =
                    trigger.getAttribute("data-copied-timeout") || 5000;
          ...
          __core
            ...
            .then(function (cond) {
              ...
              if (!tipsEl) {
                ...
                __core.getVars.elWrapper.insertAdjacentHTML(
                  "beforeend",
                  tipsHTML,
                );
              ...
              var tipsTitle = document.getElementById(
                "cnvs-tips-element-title",
              );
              var tipsContent = document.getElementById(
                "cnvs-tips-element-content",
              );
              var tipsDisable = document.getElementById(
                "cnvs-tips-element-disable",
              );
              var tipsEnable = document.getElementById(
                "cnvs-tips-element-enable",
              );
              ...
              if (tipsDisable) {
                tipsDisable.onclick = function (e) {
                  ...
                  var tipsToast = bootstrap.Toast.getOrCreateInstance(
      ...
      return {
        init: function (selector) {
          ...
          selector.forEach(function (mediaWrap) {
            ...
            var mediaTrigger = mediaWrap.querySelector(
              ".media-trigger-playback",
            );
            var volumeTrigger = mediaWrap.querySelector(
      ...
      return {
        init: function (selector) {
          ...
          selector.forEach(function (el) {
            ...
            var elRootMargin =
              el.getAttribute("data-viewport-rootmargin") || "0px";
            ...
            elClassTarget = elClassTarget
              ? document.querySelector(elClassTarget)
              : false;
        ...
        var onScroll = function (params) {
          fastdom.measure(function () {
            ...
            if (position >= params.start && position <= params.end) {
              ...
              if (
                position > params.start + params.height &&
                ...
                selector.forEach(function (elem) {
                  ...
                  if (scrollOffset) {
                    ...
                    if (scrollOffset.length > 1) {
                      elemOffset =
                        elemOffset +
                        viewportHeight * Number(scrollOffset[0]) * 0.01;
                  ...
                  if (
                    includeWidth == "true" ||
                    (elem.classList.contains("parallax") &&
      ...
      return {
        init: function (selector) {
          ...
          selector.forEach(function (elem) {
            ...
            var percent = defaultSize * Number(step) * 0.01;
          ...
          __core
            ...
            .then(function (cond) {
              ...
              var tooltips = [].slice.call(
                __core.getVars.baseEl.querySelectorAll(
              ...
              var tabTargetShow = function (target) {
                ...
                if (
                  __core.getVars.hash &&
                  document.querySelector(
                    '[data-bs-target="' + __core.getVars.hash + '"]',
                  )
                ) {
                  setTimeout(function () {
                    __core.scrollTo(
                      __core.offset(target).top -
                        __core.getVars.topScrollOffset -
                        20,
                      0,
                      false,
              ...
              document.querySelectorAll(".canvas-tabs").forEach(function (el) {
                ...
                if (activeTab) {
                  ...
                  tabTargetShow(
                    el.querySelectorAll("[data-bs-target]")[activeTab],
                  );
                }
              });
              ...
              tabs.forEach(function (el) {
                el.addEventListener("shown.bs.tab", function (e) {
                  if (!el.classList.contains("container-modules-loaded")) {
                    var tabContent = el.getAttribute("data-bs-target")
