    ...
    f = function (i) {
      return (
        (i === r && t.currTemplate.closeBtn) ||
          ...
          t.currTemplate.closeBtn.html(t.st.closeIcon),
          (r = i)),
    ...
    parseEl: function (i) {
      ...
      if (
        ...
        ((o.src = o.el.attr("data-mfp-src")),
          ...
          (o.srcset = o.el.attr("data-srcset") || ""),
          (o.sizes = o.el.attr("data-sizes") || ""));
      }
      return (
      ...
      getInline: function (i, n) {
        if ((C(), i.src)) {
          ...
          if (a.length) {
            ...
            (r &&
              r.tagName &&
              (v || ((g = o.hiddenClass), (v = p(g)), (g = "mfp-" + g)),
