...
(function () {
  ...
  function _positionHotspots(options) {
    var imageWidth = $(options.mainselector + " " + options.imageselector).prop(
      "naturalWidth",
    );
    var imageHeight = $(
      options.mainselector + " " + options.imageselector,
    ).prop("naturalHeight");
    ...
    $(options.selector).each(function () {
      ...
      $(this)
        .children(options.tooltipselector)
        .css({
          "margin-left": -(
            $(this).children(options.tooltipselector).width() / 2
          ),
        });
    });
  }
  ...
  function _bindHotspots(e, options) {
    if ($(e).children(options.tooltipselector).is(":visible")) {
      ...
      $(options.selector + " " + options.tooltipselector).css(
        "display",
        "none",
      );
      ...
      if (
        $(window).width() -
          ($(e).children(options.tooltipselector).offset().left +
            $(e).children(options.tooltipselector).outerWidth()) <
        0
      ) {
