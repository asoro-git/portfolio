...
!(function () {
  ...
  const jo = (e) => (t) => !!t && t.nodeType === e,
    ...
    jr = (e) => (
      zr(e) && (e = e.parentNode),
      Ur(e) && e.hasAttribute("data-mce-caret")
    ),
    Hr = (e) => zr(e) && Ir(e.data),
    $r = (e) => jr(e) || Hr(e),
    ...
    hu = (e, t) => {
      ...
      return Jo(n)
        ...
        : n
          ? ss(n)
            ? I.some(
                e ? Li.before(n) : rr((o = n)) ? Li.before(o) : Li.after(o),
              )
            : ((e, t, n) => {
        ...
        e
          ? ((e, t) =>
              Qp(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    bu(e, Li.after(t)).orThunk(() => vu(e, Li.before(t))))(
                    e,
                    t,
                  ),
                ))(t, n)
                ...
                .bind((e) => {
                  ...
                  if (r.length > 0) {
                    if (o) return I.some(Ch.partialTable(r, I.none()));
                    {
                      const e = Rh(n, t);
                      return I.some(
                        Ch.partialTable(r, I.some({ ...t, rng: e })),
                      );
                    }
                  }
                  return I.none();
    ...
    mv = (e, t, n, o, r) => {
      ...
      if ("all" !== t.remove) {
        (uv(s, l, t, n, r),
          ...
          tv(t.classes, (e) => {
            ((e = gm(e, n)),
              ($o(r) && !s.hasClass(r, e)) || s.removeClass(l, e));
          }));
      ...
      var Re = function (e) {
        ...
        Pe = function (e) {
          ...
          if (
            ...
            return (Re(e), !0);
          if ("select" === r && dy(/<template/i, e.innerHTML))
            return (Re(e), !0);
          if (!z[r] || q[r]) {
            if (!q[r] && Me(r)) {
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                hb(
                  ...
                  (n) =>
                    ue(t, (t) =>
                      ((t, n) => (xb(e, t.dom, n) ? I.some(n) : I.none()))(
                        n,
                        t,
                      ),
                    ),
            ...
            : (t && ir(o.getNode())) || (!t && ir(o.getNode(!0)))
              ? ((e, t, n, o) => {
                  ...
                  return fh(yn(e), yn(n.getNode()))
                    .map((e) =>
                      bs(e) ? bx.remove(e.dom) : bx.moveToElement(r),
                    )
                      ...
                      : ((e, t, n) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? "after" : "before";
                            return (
                              $o(n) && n.getAttribute("data-mce-caret") === o
                            );
                          })(t, n)
                            ? ((e, t) =>
                                y(t)
                                  ...
                                  : e && ir(t.nextSibling)
                                    ...
                                    : !e && ir(t.previousSibling)
                                      ? I.some(
                                          bx.moveToElement(t.previousSibling),
                                        )
    ...
    mN = {
      insert: (e, t) => {
        ...
        if (p)
          ...
          ((R = Yr(S)), i.isEmpty(S) && tN(S), nN(e, R), J_(e, R));
        else if (v(!1)) R = w();
        else if (v(!0) && N) {
  ...
  const dA = (e, t) => Math.abs(e.left - t),
    ...
    YA = (e, t, n) => {
      (zA(e, e.get(t.prefix + "-end"), n),
        zA(e, e.get(t.prefix + "-start"), n));
    },
  ...
  class OT {
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = NT.get(this.id)),
        this.targetElm
      );
    }
    getWin() {
