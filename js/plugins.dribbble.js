    ...
    u = {
      ...
      idRequired: function (e) {
        return (
          ...
          this.singular(e) +
          ' ID. ex: $.jribbble.%@("1234").'.replace(/%@/g, e)
        );
      },
      ...
      shotId: function (e) {
        return (
          ...
          ' $.jribbble.shots("1234").%@()'.replace(/%@/g, e)
        );
      },
      commentLikes:
        ...
        r = function () {
          return (
            ...
            (this.flush = function (e) {
              if (!this.flushed) {
                for (this.scope = e, this.flushed = !0; this.methods[0]; )
        ...
        return function (r, s) {
          ...
          return (
            this.queue.add(function (r) {
              ...
              ((r.url += "/" + t + "/"),
                n.resource && ((r.url += n.resource), delete n.resource),
