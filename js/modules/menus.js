CNVS.Menus = (function () {
  ...
  var _invert = function (subMenuEl) {
    ...
    subMenus.forEach(function (el) {
      ...
      if (
        __core.viewport().width - (viewportOffset.left + viewportOffset.width) <
        0
      ) {
        el.classList.add("menu-pos-invert");
      }
      ...
      .forEach(function (pMenu) {
        pMenu.querySelectorAll(".sub-menu").forEach(function (item) {
          ...
          item.addEventListener("mouseenter", function () {
            ...
            _invert(
              item.querySelectorAll(".mega-menu-content, .sub-menu-container"),
            );
          });
    ...
    document.querySelectorAll(".top-links").forEach(function (item) {
      if (
        ...
        item.querySelectorAll(".top-links-item").forEach(function (menuItem) {
          if (
            menuItem.querySelectorAll(".top-links-sub-menu,.top-links-section")
              .length > 0
          ) {
  ...
  var _current = function (
    ...
    [].slice
      .call(triggerEl.closest(".menu-container").querySelectorAll(menuItemSel))
      .forEach(function (item) {
        item.classList.remove("current");
      });
    ...
    var setCurrent = function (item, menuItemSel, subMenusSel) {
      if (
        !__core.isHidden(
          item.closest(menuItemSel).querySelector(":scope > " + subMenusSel),
        )
      ) {
    ...
    document
      ...
      .forEach(function (menuTrigger) {
        menuTrigger.onclick = function (e) {
          ...
          if (
            __core.filtered(__core.getVars.elPrimaryMenus, elTarget).length < 1
          ) {
            return;
          }
  ...
  var _fullWidth = function () {
    ...
    if (
      __core.getVars.elHeader.querySelectorAll(".container-fullwidth").length >
      0
    ) {
      document
        .querySelectorAll(
